...
The readme of every package goes straight from its one-line title to installation and usage — the description section is gone — and every options object in the examples, readmes and JSDoc alike, is written one property per line.
