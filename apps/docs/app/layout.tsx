 ...
 *
 * @defaultValue title "Novastarter Docs", description "The documentation site of the Novastarter monorepo."
 */
export const metadata: Metadata = {
	title: 'Novastarter Docs',
	description: 'The documentation site of the Novastarter monorepo.',
};
