 ...
 * point that has to stay usable outside Node. The re-exports are named rather than `export *` on purpose: the memo of
 * {@link processId} stays private to its module, where the tests reset it.
 */
